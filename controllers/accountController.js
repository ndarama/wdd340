...
async function accountLogin(req, res, next) {
    try {
        ...
        if (!accountData) {
            req.flash("notice", "The email address is not registered. Please check the email or register a new account.")
...
async function updateAccount(req, res, next) {
    ...
    if (updateResult) {
        const accountData = await accountModel.getAccountById(account_id);
        req.flash("notice", `Congratulations, ${accountData.account_firstname} your account has been updated.`);
